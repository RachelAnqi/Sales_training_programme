...
pp_info_by_hosp_product <- data.frame(
  ...
  product = rep(paste("product",rep(1:4,each=7),sep=""),10),
  #pp_acc_revenue = rep(100000,280),
  pp_real_sales = rep(100000,280),
  pp_sr_sales_performance = rep(60,280),
  pp_deployment_quality_index = rep(50,280),
  pp_customer_relationship_index = rep(50,280),
  pp_promotional_support_index = rep(50,280),
  pp_sales_performance = rep(50,280),
  pp_offer_attractiveness = rep(50,280),
  pp_acc_offer_attractiveness = rep(50,280))
