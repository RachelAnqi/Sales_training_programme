...
curve51_1 <- data.frame(x=seq(40,100,5),
                        y=c(5,7,10,13,16,19,21,23,25,27,28.5,29,30))
curve51_2 <- data.frame(x=seq(40,100,5),
                        y=c(8,11,13.5,15.5,17.5,19,20,21.5,22.5,23.5,24,24.5,25))
