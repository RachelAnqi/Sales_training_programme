        ...
        tabPanel("周期1",
                 ...
                 box(title = "总推广预算",
                     ...
                     tags$div(
                       ...
                       tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                                "口服抗生素 已分配指标(元)"),
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                                verbatimTextOutput("p1_product1"))
                     ),
                     tags$div(
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:20px;text-align:left;",
                                "已分配的推广预算(%)"),
                       ...
                       tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                                "一代降糖药 已分配指标(元)"),
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                                verbatimTextOutput("p1_product2"))
                     ),
                     tags$div(
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:20px;text-align:left;",
                       ...
                       tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                                "三代降糖药 已分配指标(元)"),
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                                verbatimTextOutput("p1_product3"))
                     ),
                     tags$div(
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:20px;text-align:left;",
                       ...
                       tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                                "皮肤药 已分配指标(元)"),
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                                verbatimTextOutput("p1_product4"))
                     ),
                     tags$div(
                       tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:20px;text-align:left;",
                ...
                box(
                  ...
                  tags$div(
                    ...
                    tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                             "口服抗生素 已分配指标(元)"),
                    tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                             verbatimTextOutput("p2_product1"))
                  ),
                  tags$div(
                    tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:20px;text-align:left;",
                             "已分配的推广预算(%)"),
                    ...
                    tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                             "一代降糖药 已分配指标(元)"),
                    tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                             verbatimTextOutput("p2_product2"))
                  ),
                  ...
                  tags$div(
                    ...
                    tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                             "三代降糖药 已分配指标(元)"),
                    tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                             verbatimTextOutput("p2_product3"))
                  ),
                  tags$div(
                    tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:20px;text-align:left;",
                             paste("已分配时间 ",sr_info$业务代表[3],"(%)",sep="")),
                    ...
                    tags$div(style = "display:inline-block;width:20%;vertical-align:middle;margin-left:10%;text-align:left;",
                             "皮肤药 已分配指标(元)"),
                    tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:10px;text-align:left",
                             verbatimTextOutput("p2_product4"))
                  ),
                  tags$div(
                    tags$div(style = "display:inline-block;width:16%;vertical-align:middle;margin-left:20px;text-align:left;",
                             paste("已分配时间 ",sr_info$业务代表[4],"(%)",sep="")),
            ...
            tabsetPanel(
              ...
              tabPanel("周期1",
                       ...
                       box(title="分配报告",
                           ...
                           tags$div(style = "margin-left:3%",
                                    selectInput("p1_report3_hosp",
                                                ...
                                                selected=NULL)),
                           tags$div(style = "margin-left:3%",
                                    selectInput("p1_report3_dim",
                                                label="选择维度",
                                                choice=c("ALL","销售代表","计划时间分配(天)","实际时间分配(天)",
                                                         "推广费用(元)"),
                                                selected=NULL)),
                       ...
                       box(title="销售报告",
                           ...
                           tags$div(style = "margin-left:3%",
                                    selectInput("p1_report6_hosp",
                                                label="选择医院",
                                                choice=c("ALL",unique(hospital_info$名称)),
                                                selected=NULL),
                                    selectInput("p1_report6_prod1",
                                                label="选择产品",
                                                choice=c("ALL","口服抗生素","一代降糖药","三代降糖药",
                                                         "皮肤药","总体"),
                                                selected=NULL)),
                           ...
                           br(),br(),br(),
                           tags$div(style = "margin-left:3%",
                                    selectInput("p1_report6_sr",
                                                label="选择代表",
                                                choice=c("ALL","小宋","小兰","小木","小白","小青"),
                                                selected=NULL),
                                    selectInput("p1_report6_prod2",
                                                label="选择产品",
                                                choice=c("ALL","口服抗生素","一代降糖药","三代降糖药",
                                                         "皮肤药","总体"),
                                                selected=NULL)),
              ...
              tabPanel("周期2",
                       ...
                       box(title="销售报告",
                           ...
                           tags$div(style = "margin-left:3%",
                                    selectInput("p2_report6_hosp",
                                                label="选择医院",
                                                choice=c("ALL",unique(hospital_info$名称)),
                                                selected=NULL),
                                    selectInput("p2_report6_prod1",
                                                label="选择产品",
                                                choice=c("ALL","口服抗生素","一代降糖药","三代降糖药",
                                                         "皮肤药","总体"),
                                                selected=NULL)),
                           ...
                           br(),br(),br(),
                           tags$div(style = "margin-left:3%",
                                    selectInput("p2_report6_sr",
                                                label="选择代表",
                                                choice=c("ALL","小宋","小兰","小木","小白","小青"),
                                                selected=NULL),
                                    selectInput("p2_report6_prod2",
                                                label="选择产品",
                                                choice=c("ALL","口服抗生素","一代降糖药","三代降糖药",
                                                         "皮肤药","总体"),
                                                selected=NULL)),
...
server=function(input, output, session) {
    ...
    output$body <- renderUI({
      ...
      } else if (user_input$authenticated == T & 
                 user_input$tocontinue == 0) { 
  ...
  #### YOUR APP'S SERVER CODE GOES HERE ----------------------------------------
    ...
    observe({
      if (user_input$tocontinue == 2) {
        director = system(paste("ls users/",input$user_name,"/ -ltr |tail -2|awk '{print $NF}'",sep=""),intern =T)[1]
        
        if (file.exists(paste("users/",input$user_name,"/",director,"/inputs.RDS",sep=""))) {
        savedInputs <- readRDS(paste("users/",input$user_name,"/",director,"/inputs.RDS",sep=""))
        toUse <- savedInputs[unique(c(grep("^p1",names(savedInputs)),grep("^p2",names(savedInputs))))]
        for (i in 1:length(toUse)) {
          
          session$sendInputMessage(names(toUse)[i],  list(value=toUse[[i]]) )
        }
  ...
  p1_calculator_result1 <- reactive({  calculator1(input,1) })
  p1_calculator_result2 <- reactive({  calculator2(input,1) })
  
  output$p1_arranged_promotional_budget <- renderText(p1_calculator_result1()[1])
  
  output$p1_arranged_time_of_sr1 <- renderText(p1_calculator_result1()[2])
  output$p1_arranged_time_of_sr2 <- renderText(p1_calculator_result1()[3])
  output$p1_arranged_time_of_sr3 <- renderText(p1_calculator_result1()[4])
  output$p1_arranged_time_of_sr4 <- renderText(p1_calculator_result1()[5])
  output$p1_arranged_time_of_sr5 <- renderText(p1_calculator_result1()[6])
  
  output$p1_product1 <- renderText(p1_calculator_result2()[1])
  output$p1_product2 <- renderText(p1_calculator_result2()[2])
  output$p1_product3 <- renderText(p1_calculator_result2()[3])
  output$p1_product4 <- renderText(p1_calculator_result2()[4])
  ...
  observeEvent(input$decision2_phase1_submit,{
    ...
    else if (p1_calculator_result1()[1]==0|
        p1_calculator_result1()[2]==0|
        p1_calculator_result1()[3]==0|
        p1_calculator_result1()[4]==0|
        p1_calculator_result1()[5]==0|
        p1_calculator_result1()[6]==0) {
      shinyjs::alert("代表已分配时间或推广预算已分配不能为0")
    } else if (
      p1_calculator_result1()[1] >100 | 
      p1_calculator_result1()[2] >100 | 
      p1_calculator_result1()[3] >100 | 
      p1_calculator_result1()[4] >100 | 
      p1_calculator_result1()[5] >100 | 
      p1_calculator_result1()[6] >100 | 
  ...
  p1_report <- eventReactive(input$decision2_phase1_submit,{
    if (
      ...
      p1_calculator_result1()[1]>0&p1_calculator_result1()[1] <=100 &
      p1_calculator_result1()[2]>0&p1_calculator_result1()[2] <=100 &
      p1_calculator_result1()[3]>0&p1_calculator_result1()[3] <=100 &
      p1_calculator_result1()[4]>0&p1_calculator_result1()[4] <=100 &
      p1_calculator_result1()[5]>0&p1_calculator_result1()[5] <=100 &
      p1_calculator_result1()[6]>0&p1_calculator_result1()[6] <=100 &
      sum(p1_flm_data()) <=worktime
    ) {
  ...
  p1_report3_mod1 <- reactive({
    ...
    if (input$p1_report3_hosp=="ALL" & input$p1_report3_dim=="ALL" ) {
      out <- data
    } else if (input$p1_report3_hosp!="ALL" & input$p1_report3_dim=="ALL" ){
      
      out <- data[which(data$医院%in%input$p1_report3_hosp),]
    } else if (input$p1_report3_hosp=="ALL" & input$p1_report3_dim!="ALL" ){
      
      out <- data[which(data$因素%in%input$p1_report3_dim),]
    } else {
      out <- data[which(data$因素%in%input$p1_report3_dim & data$医院%in%input$p1_report3_hosp),]
    }
  ...
  p1_report6_mod1 <- reactive({
    ...
    chosen_hosp = input$p1_report6_hosp
    chosen_prod = input$p1_report6_prod1 
    if (chosen_hosp =="ALL" & chosen_prod =="ALL") {
      out <- data
    } else if (chosen_hosp=="ALL" & chosen_prod !="ALL") {
      out <- data[which(data$产品%in%chosen_prod),]
    } else if (chosen_hosp!="ALL" & chosen_prod =="ALL") {
      out <- data[which(data$医院%in%chosen_hosp),]
    } else {
      out <- data[which(data$医院%in%chosen_hosp & data$产品%in%chosen_prod),]
    }
  ...
  p1_report6_mod2 <- reactive({
    data <- p1_report()$report6_mod2
    chosen_sr = input$p1_report6_sr
    chosen_prod = input$p1_report6_prod2 
    if (chosen_sr =="ALL" & chosen_prod =="ALL") {
      out <- data
    } else if (chosen_sr=="ALL" & chosen_prod !="ALL") {
      out <- data[which(data$产品%in%chosen_prod),]
    } else if (chosen_sr!="ALL" & chosen_prod =="ALL") {
      out <- data[which(data$销售代表%in%chosen_sr),]
    } else {
      out <- data[which(data$销售代表%in%chosen_sr & data$产品%in%chosen_prod),]
    }
  ...
  output$p1_report6_2 <- 
    renderDataTable(datatable(p1_report6_mod2(),
                              rownames = F,
                              caption="销售额/代表",
                              options = 
                                list(pageLength = 200,
  ...
  p2_calculator_result1 <- reactive(calculator1(input,2))
  
  p2_calculator_result2 <- reactive(calculator2(input,2))
  
  
  
  output$p2_arranged_promotional_budget <- renderText(p2_calculator_result1()[1])
  output$p2_arranged_time_of_sr1 <- renderText(p2_calculator_result1()[2])
  output$p2_arranged_time_of_sr2 <- renderText(p2_calculator_result1()[3])
  output$p2_arranged_time_of_sr3 <- renderText(p2_calculator_result1()[4])
  output$p2_arranged_time_of_sr4 <- renderText(p2_calculator_result1()[5])
  output$p2_arranged_time_of_sr5 <- renderText(p2_calculator_result1()[6])
  
  
  output$p2_product1 <- renderText(p2_calculator_result2()[1])
  output$p2_product2 <- renderText(p2_calculator_result2()[2])
  output$p2_product3 <- renderText(p2_calculator_result2()[3])
  output$p2_product4 <- renderText(p2_calculator_result2()[4])
  ...
  observeEvent(input$decision2_phase2_submit,{
    ...
    else if (p2_calculator_result1()[1]==0|
        p2_calculator_result1()[2]==0|
        p2_calculator_result1()[3]==0|
        p2_calculator_result1()[4]==0|
        p2_calculator_result1()[5]==0|
        p2_calculator_result1()[6]==0) {
      shinyjs::alert("代表已分配时间或推广预算已分配不能为0")
    } else if (
      p2_calculator_result1()[1] >100 | 
      p2_calculator_result1()[2] >100 | 
      p2_calculator_result1()[3] >100 | 
      p2_calculator_result1()[4] >100 | 
      p2_calculator_result1()[5] >100 | 
      p2_calculator_result1()[6] >100 | 
  ...
  p2_report<- eventReactive(input$decision2_phase2_submit,{
    if (
      ...
      p2_calculator_result1()[1] <=100 & p2_calculator_result1()[1]>0&
      p2_calculator_result1()[2] <=100 & p2_calculator_result1()[2]>0&
      p2_calculator_result1()[3] <=100 & p2_calculator_result1()[3]>0&
      p2_calculator_result1()[4] <=100 & p2_calculator_result1()[4]>0&
      p2_calculator_result1()[5] <=100 & p2_calculator_result1()[5]>0&
      p2_calculator_result1()[6] <=100 & p2_calculator_result1()[6]>0&
  ...
  p2_report3_mod1 <- reactive({
    ...
    if (input$p2_report3_hosp=="ALL" & input$p2_report3_dim=="ALL" ) {
      out <- data
    } else if (input$p2_report3_hosp!="ALL" & input$p2_report3_dim=="ALL" ){
      
      out <- data[which(data$医院%in%input$p2_report3_hosp),]
    } else if (input$p2_report3_hosp=="ALL" & input$p2_report3_dim!="ALL" ){
      
      out <- data[which(data$因素%in%input$p2_report3_dim),]
    } else {
      out <- data[which(data$因素%in%input$p2_report3_dim & data$医院%in%input$p2_report3_hosp),]
    }
  ...
  p2_report6_mod1 <- reactive({
    ...
    chosen_hosp = input$p2_report6_hosp
    chosen_prod = input$p2_report6_prod1 
    if (chosen_hosp =="ALL" & chosen_prod =="ALL") {
      out <- data
    } else if (chosen_hosp=="ALL" & chosen_prod !="ALL") {
      out <- data[which(data$产品%in%chosen_prod),]
  ...
  p2_report6_mod2 <- reactive({
    data <- p2_report()$report6_mod2
    chosen_sr = input$p2_report6_sr
    chosen_prod = input$p2_report6_prod2 
    if (chosen_sr =="ALL" & chosen_prod =="ALL") {
      out <- data
    } else if (chosen_sr=="ALL" & chosen_prod !="ALL") {
      out <- data[which(data$产品%in%chosen_prod),]
  ...
  output$p2_report6_2 <- 
    renderDataTable(datatable(p2_report6_mod2(),
                              rownames = F,
                              caption="销售额/代表",
                              options = 
                                list(pageLength = 200,
  ...
  user_input <- reactiveValues(authenticated = FALSE, valid_credentials = FALSE, 
                               ...
                               times = NULL,time = NULL,tocontinue = 0)
 ...
 observeEvent(input$yes,{
   user_input$tocontinue <- 2
 })
 
 observeEvent(input$no,{
   user_input$tocontinue <- 1
 })
