...
curve30 <- data.frame(x=c(0,300,1000,1500,1800,2000,2200,2500,3000,4000,5000)*20,
...
curve49 <- data.frame(x=c(0,30000,60000,90000,120000,150000,200000,250000,300000,350000,400000)*30,
