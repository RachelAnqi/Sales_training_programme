...
curve30 <- data.frame(x=c(0,300,1000,1500,1800,2000,2200,2500,3000,4000,5000)*6,
...
curve50 <- data.frame(x=c(0,150000,300000,450000,600000,750000,900000,1050000,1200000,1350000,1500000)*7,
